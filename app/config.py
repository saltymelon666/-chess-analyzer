...
def load_settings() -> Settings:
    ...
    return Settings(
        ...
        game_analysis_depth=max(6, int(_value("GAME_ANALYSIS_DEPTH", defaults, "20"))),
        game_analysis_timeout_seconds=float(_value("GAME_ANALYSIS_TIMEOUT_SECONDS", defaults, "1200")),
